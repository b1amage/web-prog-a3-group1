    ...
    <header>
        <main>
            <nav class="first-nav">
                ...
                <nav class="nav__pc">
                    <ul class="nav__list">
                        <li><a href="./store.php?store_id=<?=$id_store?>" class="nav__link push" id="underline">Home</a></li>
                ...
                <nav class="nav__mobile">
                    ...
                    <ul class="nav__mobile-list">
                        <li><a href="./store.php?store_id=<?=$id_store?>" class="nav__mobile-link">Home</a></li>
